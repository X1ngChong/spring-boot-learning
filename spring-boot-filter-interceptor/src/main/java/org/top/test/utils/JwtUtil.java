...
public class JwtUtil {
     ...
     */
    private static final String KEY = "spring-boot-learning-hub";
    ...
    public static boolean validate(String token) {
        try {
            ...
            throw new ServerException(ErrorCode.JWT_CHECK_ERROR);
        }
    }
    ...
    public static String getAccessToken(HttpServletRequest request) {
        String accessToken = request.getHeader(Constant.HEADER);
